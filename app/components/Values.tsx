			...
			<div className="container px-4 mx-auto">
				<div className="max-w-4xl mb-12 text-left">
					...
					<p className="text-lg md:text-xl text-coolGray-500 font-medium">
						At Mighty Orchid Services, our values define us. Care, Respect,
						Accountability and Collaboration are at the core of all we do. They
						guide our commitment to the well-being and success of every
						individual we support, driving us to create positive impact every
						day.
					</p>
				</div>
