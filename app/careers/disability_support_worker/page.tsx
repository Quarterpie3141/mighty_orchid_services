    ...
    >
      <div className="container mx-auto p-6">
        <section className="bg-[rgba(255,255,255,0.6)] py-8 px-12 shadow-md rounded-lg mb-8">
          <h1 className="text-3xl font-bold mb-4">Job Position: Support Worker</h1>
          <p className="text-lg mb-4">
            As a Support Worker at Mighty Orchid Services, you will provide assistance to individuals with disabilities, helping them achieve their personal goals and maintain their independence. You will be part of a dedicated team committed to delivering high-quality care.
          </p>
          <h2 className="text-2xl font-semibold mb-4">Key Responsibilities</h2>
          <ul className="list-disc list-inside mb-4">
            <li>Assist clients with daily living tasks such as meal preparation, cleaning, and laundry. </li>
            <li>Provide personal care including bathing, dressing, grooming, and medication management. </li>
            <li>Foster emotional and mental well-being through companionship and empathetic engagement. </li>
            <li>Regularly assess client needs, maintain detailed health records, and report any significant changes. </li>
            <li>Support clients in maintaining and developing their independence. </li>
            <li>Adhere to safety protocols and infection control measures. </li>
          </ul>
          <h2 className="text-2xl font-semibold mb-4">Required Skills and Qualifications</h2>
          <ul className="list-disc list-inside mb-4">
            <li>Completion of NDIS Worker Orientation Program and Supporting People to Stay Infection Free module. </li>
            <li>{`Necessary certifications such as Working with Children Check (if applicable) and NDISWC.`} </li>
            <li>{`Must have a valid Driver's License and Passport.`} </li>
            <li>At least six months of experience in a support role. </li>
            <li>Certificate III or IV in Individual Support, or a Diploma in Community Services is preferred. </li>
            <li>Physical capability to perform job duties. </li>
            <li>Ability to work independently and collaboratively within a team. </li>
            <li>A compassionate and patient approach with strong interpersonal and communication skills. </li>
          </ul>
        </section>
        ...
        <section className="bg-[rgba(255,255,255,0.6)] py-8 px-12 shadow-md rounded-lg">
          ...
          <p className="text-lg mb-4">
            If you are interested in applying, please send an email to <a href="mailto:info@mtos.com.au" className=" text-mto-orange hover:text-mto-blue transition">Info@mtos.com.au</a> with your personal details and resume.
          </p>
        </section>
      </div>
    </section>
    ...
    <section
        ...
        >
          ...
          <div className=' flex justify-center px-4 mx-auto'>
            <a href="https://kdcci.com.au/"><img className="w-72 p-5 mr-40 " src="https://mtos.com.au/other-assets/KDCCI.jpg"></img></a>
            <a href="https://www.onslowcci.com.au/"><img className=" w-72 p-5 mt-10" src="https://mtos.com.au/other-assets/OCCI.svg"></img></a>
          </div>
    </section>
    </>
    );
